...
__all__ = [
    '_ISpeechVoiceEvents', 'SWTAdded', 'SpeechAudioState',
    'DISPID_SASCurrentSeekPosition', 'SINone', 'DISPID_SDKOpenKey',
    'SPCT_SLEEP', 'SpObjectTokenCategory', 'DISPID_SPRuleChildren',
    'SPLO_DYNAMIC', 'DISPID_SRCEPropertyStringChange', 'SLOStatic',
    'SRSActive', 'SpMMAudioEnum', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SLPsCount', 'DISPID_SRCEInterference',
    'SpeechWordPronounceable', 'SVSFUnusedFlags',
    'SPRECOCONTEXTSTATUS', 'SPSERIALIZEDRESULT',
    'DISPID_SRCSetAdaptationData', 'STSF_AppData',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechPhoneConverter',
    'SREAllEvents', 'SpStream', 'DISPID_SPPConfidence', 'SP_VISEME_7',
    'SpeechInterference', 'SpPhoneConverter', 'SPWORD',
    'ISpeechPhraseInfo', 'SPFM_CREATE', 'SpeechVoiceSpeakFlags',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPPNumberOfElements', 'SpeechEmulationCompareFlags',
    'SRADefaultToActive', 'DISPID_SGRClear', 'Speech_Max_Word_Length',
    'SP_VISEME_17', 'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SGRsItem',
    'SVP_5', 'eLEXTYPE_PRIVATE14', 'SAFT32kHz16BitStereo',
    '_ISpeechRecoContextEvents', 'Speech_StreamPos_Asap',
    'SpInprocRecognizer', 'SPAS_RUN', 'SPSNotOverriden',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SLWLangId',
    'SpeechCategoryAudioIn', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPBO_AHEAD', 'SpeechPropertyHighConfidenceThreshold', 'IStream',
    'DISPID_SOTCSetId', 'SVP_1', 'SpeechAllElements',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SOTsCount', 'SPSNoun',
    'ISpEventSource', 'DISPID_SpeechLexicon', 'SPRS_ACTIVE',
    'SpNotifyTranslator', 'SDKLLocalMachine', 'SVP_15',
    'SAFT32kHz16BitMono', 'eLEXTYPE_LETTERTOSOUND', 'SREHypothesis',
    'SPWAVEFORMATTYPE', 'DISPID_SLPType', 'SGRSTTRule',
    'DISPID_SpeechPhraseProperty', 'SAFT48kHz16BitMono', 'SRARoot',
    'DISPID_SGRSTNextState', 'DISPID_SPPChildren',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTCCITT_ALaw_11kHzMono',
    'SSSPTRelativeToCurrentPosition', 'SVP_7', 'ISpRecoResult',
    'SPDKL_CurrentUser', 'DISPID_SVIsUISupported',
    'SpeechAudioProperties', 'DISPID_SDKGetlongValue',
    'DISPID_SBSWrite', 'SpInProcRecoContext', 'SpeechRecognizerState',
    'SRTStandard', 'SREStateChange', 'SpeechPartOfSpeech',
    'SGSEnabled', 'SVSFVoiceMask', 'SPDKL_DefaultLocation',
    'DISPID_SRGDictationLoad', 'SpeechPropertyAdaptationOn',
    'DISPID_SPIEngineId', 'DISPID_SASetState', 'SPRECORESULTTIMES',
    'ISpeechPhraseRule', 'DISPID_SGRSTType',
    'SpeechTokenIdUserLexicon', 'DISPID_SPRFirstElement', 'SBONone',
    'SPPS_LMA', 'DISPID_SVSInputWordLength', 'ISequentialStream',
    'DISPID_SOTGetDescription', 'STCAll',
    'SWPUnknownWordPronounceable', 'SPPS_Unknown', 'DISPID_SPAsItem',
    'eLEXTYPE_VENDORLEXICON', 'SPINTERFERENCE_NOISE',
    'SPSInterjection', 'SPPHRASEPROPERTY', 'DISPID_SOTRemove',
    'SAFT16kHz8BitStereo', 'DISPID_SRRTLength',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SDTAudio',
    'SVEAudioLevel', 'DISPID_SOTId', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVSPhonemeId',
    'ISpeechGrammarRuleStateTransition', 'ISpRecoContext',
    'SpResourceManager', 'SP_VISEME_9', 'SPEI_PHRASE_START',
    'SSTTDictation', 'SpeechCategoryAudioOut',
    'DISPID_SLAddPronunciationByPhoneIds',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SPAsCount',
    'ISpeechRecoResultTimes', 'ISpeechLexicon', 'SVP_12',
    'ISpeechRecoContext', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRCEEnginePrivate', 'SPFILEMODE', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechRecoResult', 'SPSHORTCUTPAIR',
    'SVSFPurgeBeforeSpeak', 'SECFIgnoreWidth', 'DISPIDSPRG',
    'DISPID_SOTDataKey', 'ISpeechVoiceStatus',
    'DISPID_SGRInitialState', 'SPSSuppressWord',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPEsItem',
    'DISPID_SVEAudioLevel', 'SpeechTokenKeyUI', 'SPCT_COMMAND',
    'eLEXTYPE_APP', 'SP_VISEME_2', 'SpeechRecognitionType',
    'SPSHT_NotOverriden', 'SAFTDefault', 'SVEViseme', 'SPSModifier',
    'SPRST_INACTIVE', 'SPLO_STATIC', 'ISpeechRecognizerStatus',
    'SpeechWordType', 'DISPID_SOTCategory', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SpeechMemoryStream', 'SAFTADPCM_22kHzStereo',
    'SpeechAudioFormatType', 'DISPID_SVDisplayUI',
    'SPFM_CREATE_ALWAYS', 'SAFTNonStandardFormat',
    'ISpPhoneticAlphabetConverter', 'SpeechDisplayAttributes',
    'SpeechMicTraining', 'SGRSTTWord', 'DISPID_SRRRecoContext',
    'SpeechRuleState', 'SPEI_HYPOTHESIS', 'SpSharedRecognizer',
    'ISpeechPhraseAlternate', 'eLEXTYPE_PRIVATE4', 'SpAudioFormat',
    'SASClosed', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SDKEnumKeys', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPRulesCount', 'SAFT12kHz16BitStereo', 'SECFIgnoreCase',
    'SpeechTokenContext', 'eLEXTYPE_PRIVATE6', 'SDKLDefaultLocation',
    'DISPID_SBSFormat', 'ISpeechVoice', 'DISPID_SVGetAudioOutputs',
    'SpLexicon', 'DISPID_SpeechVoiceEvent', 'DISPID_SRRAudio',
    'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_5', 'DISPID_SVSpeak', 'SVP_3',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SABIEventBias',
    'ISpNotifyTranslator', 'DISPID_SpeechObjectTokenCategory',
    'SVSFIsFilename', 'DISPID_SRGReset',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPAPhraseInfo',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPEAudioSizeTime',
    'SGSDisabled', 'SPSEMANTICERRORINFO', 'SGSExclusive',
    'DISPID_SLGenerationId', 'SPXMLRESULTOPTIONS',
    'eLEXTYPE_RESERVED8', 'DISPID_SDKEnumValues', 'SPPS_SuppressWord',
    'DISPID_SPRNumberOfElements', 'DISPID_SRRTTickCount',
    'DISPID_SRRecognizer', 'DISPID_SRState', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SABufferNotifySize', 'SRATopLevel', 'ISpShortcut',
    'SGRSTTTextBuffer', 'SAFTCCITT_ALaw_22kHzStereo', 'SASRun',
    'SPSVerb', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCState',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRSAudioStatus',
    'SSSPTRelativeToStart', 'ISpeechPhraseProperty', 'SPRECOSTATE',
    'DISPID_SRCCreateResultFromMemory', 'SAFTGSM610_11kHzMono',
    'SITooQuiet', 'SRADynamic', 'DISPID_SPRsItem', 'DISPID_SVEViseme',
    'SpObjectToken', 'SPCT_DICTATION', 'SpMMAudioIn',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SREmulateRecognition', 'SPEI_RECO_STATE_CHANGE',
    'SPEI_ADAPTATION', 'DISPID_SLWWord', 'ISpeechObjectTokenCategory',
    'SPSHT_OTHER', 'SPSERIALIZEDPHRASE', 'STSF_FlagCreate',
    'ISpDataKey', 'SP_VISEME_21', 'SPWF_INPUT', 'eLEXTYPE_RESERVED4',
    'DISPID_SVEWord', 'SPBOOKMARKOPTIONS',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_MAX_TTS', 'SVP_18',
    'SREPhraseStart', 'DISPID_SDKDeleteKey',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechRecoGrammar',
    'SFTSREngine', 'SP_VISEME_4', 'DISPID_SPPs_NewEnum', 'SVP_17',
    'SAFTCCITT_ALaw_44kHzMono', 'SVP_0', 'ISpeechObjectTokens',
    'DISPID_SGRsCount', 'ISpeechObjectToken', 'SAFTADPCM_11kHzMono',
    'DISPID_SPIRetainedSizeBytes', 'ISpPhoneticAlphabetSelection',
    'ISpeechPhraseInfoBuilder', 'SpeechFormatType', 'ISpEventSink',
    'SPEI_INTERFERENCE', 'DISPID_SOTIsUISupported',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRSetPropertyString',
    'SAFT24kHz16BitMono', 'SPEVENTENUM', 'ISpStreamFormatConverter',
    'DISPID_SDKSetStringValue', 'SPPS_Verb', 'DISPID_SRCVoice',
    'SpWaveFormatEx', 'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_RESERVED6',
    'DISPID_SADefaultFormat', 'ISpRecoGrammar', 'DISPID_SVEPhoneme',
    'SP_VISEME_12', 'SRSActiveAlways', 'DISPID_SPIGetText',
    'DISPID_SMSSetData', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEPhraseStart', 'SpeechRetainedAudioOptions',
    'DISPID_SRCERecognition', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechCategoryPhoneConverters', 'DISPID_SGRId', 'DISPIDSPTSI',
    'SPCT_SUB_COMMAND', 'SAFT8kHz16BitStereo', 'SAFT48kHz16BitStereo',
    'ISpeechLexiconPronunciations', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRAudioInputStream', 'SAFT22kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRCEEndStream',
    'SpeechCategoryVoices', 'SpeechAudioFormatGUIDWave',
    'SpStreamFormatConverter', 'SPPS_RESERVED2',
    'SAFTGSM610_22kHzMono', 'SPEI_SOUND_START',
    'DISPID_SRRGetXMLResult', 'SPRECOGNIZERSTATUS', 'SDTRule',
    'SPEI_FALSE_RECOGNITION', 'SpCompressedLexicon',
    'DISPID_SOTCreateInstance', 'IInternetSecurityManager',
    'DISPID_SPPId', 'SREInterference', 'DISPID_SVEventInterests',
    'SVF_Emphasis', 'DISPID_SPIProperties',
    'DISPID_SRCEventInterests', 'SPCS_ENABLED', 'SAFT22kHz8BitMono',
    'SAFT48kHz8BitStereo', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SVVolume', 'SDTAll', 'ISpLexicon', 'SAFT24kHz16BitStereo',
    'SPPS_Noun', 'SGLexicalNoSpecialChars', 'SVF_None',
    'DISPID_SGRsAdd', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SOTs_NewEnum', 'DISPID_SVSRunningState', 'ISpObjectToken',
    'SVP_14', 'ISpeechGrammarRuleStateTransitions',
    'SAFT44kHz8BitStereo', 'SPPS_NotOverriden', 'IEnumString',
    'eLEXTYPE_USER', 'DISPID_SGRSTPropertyName', 'SPAS_CLOSED',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SWFESamplesPerSec',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE10',
    'SAFTADPCM_44kHzStereo', 'SGDSActiveWithAutoPause',
    'ISpeechGrammarRules', 'SRERequestUI', 'SVSFIsNotXML',
    'DISPID_SVVoice', 'ISpXMLRecoResult',
    'SpeechCategoryRecoProfiles', 'SpeechAddRemoveWord',
    'SAFT32kHz8BitMono', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCEAudioLevel', 'Speech_StreamPos_RealTime',
    'DISPID_SRCPause', 'DISPID_SGRSTWeight', 'DISPID_SVSpeakStream',
    'SVSFDefault', 'SpeechRecoEvents', 'SPLEXICONTYPE',
    'DISPID_SRRTimes', 'ISpeechAudioFormat',
    'DISPID_SVESentenceBoundary', 'DISPID_SLRemovePronunciation',
    'ISpNotifySource', 'SPEI_PHONEME',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_REQUEST_UI',
    'SPVPRI_NORMAL', 'SPEI_RESERVED3', 'SVSFParseSsml',
    'DISPID_SPIAudioSizeTime', 'SITooFast', 'SWTDeleted',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSRule',
    'SPEVENTSOURCEINFO', 'SP_VISEME_10', 'SPAUDIOOPTIONS',
    'SRSInactive', 'DISPID_SVEEnginePrivate', 'SPDKL_CurrentConfig',
    'DISPID_SOTGetAttribute', 'SpShortcut', 'SREFalseRecognition',
    'DISPID_SABIBufferSize', 'SpeechPropertyResponseSpeed',
    'SPEI_MIN_TTS', 'SRTAutopause', 'DISPID_SLPLangId',
    'DISPID_SRCreateRecoContext', 'SAFT11kHz16BitMono',
    'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE7', 'SPDKL_LocalMachine',
    'SpeechTokenKeyAttributes', 'DISPID_SRGIsPronounceable',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechRecoProfileProperties', 'DISPID_SPEActualConfidence',
    'DISPID_SOTMatchesAttributes', 'SP_VISEME_18',
    'DISPID_SMSGetData', 'SPEI_RESERVED2', 'DISPID_SVAlertBoundary',
    'DISPID_SGRSTText', 'SpeechVoiceEvents', 'SpeechRuleAttributes',
    'SpeechGrammarRuleStateTransitionType', 'SVSFlagsAsync',
    'DISPID_SPISaveToMemory', 'DISPID_SVGetAudioInputs',
    'DISPID_SVGetProfiles', 'SLODynamic', '_RemotableHandle',
    'SPSHT_EMAIL', 'DISPID_SGRsFindRule', 'SDTLexicalForm',
    'SAFT48kHz8BitMono', 'DISPID_SpeechMMSysAudio',
    'SECHighConfidence', 'DISPID_SRCRetainedAudioFormat',
    'SPEI_VOICE_CHANGE', 'SREPropertyNumChange', 'SPBO_TIME_UNITS',
    'DISPID_SRGSetWordSequenceData',
    'DISPID_SVSLastStreamNumberQueued', 'SVEBookmark',
    'SpeechBookmarkOptions', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechPhraseElement', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPIGrammarId', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechLexiconWord', 'ISpeechAudio', 'DISPID_SPRulesItem',
    'DISPID_SPCPhoneToId', 'DISPID_SVStatus', 'SRAImport',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SMSAMMHandle',
    'SPPS_Noncontent', 'DISPID_SVEStreamEnd', 'SPFM_OPEN_READONLY',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechDataKey', 'DISPID_SPPsItem',
    '_SPAUDIOSTATE', 'eLEXTYPE_PRIVATE5', 'DISPID_SGRSTsCount',
    'ISpeechRecoResult', 'eLEXTYPE_PRIVATE20',
    'ISpeechPhraseProperties', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_ALaw_8kHzMono', 'SPGS_DISABLED', 'DISPID_SVPause',
    'SSTTTextBuffer', 'eLEXTYPE_PRIVATE19', 'SAFTText',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPEs_NewEnum',
    'DISPID_SVSLastBookmark', 'SVP_16', 'SVP_11', 'SPCONTEXTSTATE',
    'SPVPRIORITY', 'DISPID_SVSkip', 'eLEXTYPE_RESERVED9',
    'IInternetSecurityMgrSite', 'DISPID_SpeechLexiconWord',
    'SPVOICESTATUS', 'DISPID_SVEStreamStart', 'ISpRecognizer',
    'DISPID_SpeechPhraseRule', 'SVP_20', 'SAFTCCITT_ALaw_22kHzMono',
    'Speech_Default_Weight', 'DISPID_SLPsItem',
    'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE13',
    'DISPID_SWFEExtraData', 'ISpPhraseAlt',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPIEnginePrivateData',
    'DISPID_SRCCreateGrammar', 'SVP_8', 'SPEI_START_SR_STREAM',
    'ISpMMSysAudio', 'SRCS_Enabled', 'SPSHORTCUTTYPE',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SVWaitUntilDone',
    'SP_VISEME_6', 'SpeechGrammarState', 'DISPID_SRGDictationUnload',
    'SRESoundEnd', 'SAFT24kHz8BitStereo', 'SDTReplacement',
    'ISpeechPhraseReplacement', 'SpeechRegistryUserRoot',
    'SAFTADPCM_22kHzMono', 'SPBINARYGRAMMAR', 'DISPID_SRGetFormat',
    'DISPID_SVRate', 'DISPID_SLPPartOfSpeech', 'SPPS_Function',
    'SPEI_RESERVED6', 'SpUnCompressedLexicon', 'SPAR_Unknown',
    'DISPID_SRSSupportedLanguages', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechStreamSeekPositionType', 'DISPID_SRCRetainedAudio',
    'DISPID_SAFType', 'SPRULE', 'SP_VISEME_11',
    'SWPKnownWordPronounceable', 'SpeechGrammarTagWildcard',
    'SAFTGSM610_44kHzMono', 'DISPID_SRCESoundStart',
    'DISPID_SPCIdToPhone', 'DISPID_SGRSAddWordTransition',
    'SRTSMLTimeout', 'SpMemoryStream', 'DISPID_SVAudioOutput',
    'DISPID_SGRSTransitions', 'DISPID_SPEAudioStreamOffset',
    'SAFTADPCM_11kHzStereo', 'DISPID_SVPriority',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPRuleFirstElement',
    'DISPID_SPIElements', 'DISPID_SpeechFileStream',
    'SAFTNoAssignedFormat', 'SpeechSpecialTransitionType',
    'SPAR_Medium', 'SPAO_NONE', 'SPDATAKEYLOCATION',
    'SDA_No_Trailing_Space', 'ISpeechDataKey',
    'DISPID_SPERequiredConfidence', 'SRSEDone', 'DISPID_SLWType',
    'SpPhraseInfoBuilder', 'ISpeechMMSysAudio',
    'DISPID_SRRAlternates', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechEngineProperties', 'SpeechLoadOption', 'SAFT44kHz8BitMono',
    'SITooSlow', 'STCInprocHandler', 'SVP_19',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechCustomStream',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRules_NewEnum',
    'ISpGrammarBuilder', 'DISPID_SRGState',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPEDisplayText',
    'DISPID_SRSetPropertyNumber', 'SVEEndInputStream',
    'DISPID_SGRs_NewEnum', 'ISpNotifySink', 'SSFMCreateForWrite',
    'STSF_CommonAppData', 'DISPID_SVSLastBookmarkId',
    'SPWT_PRONUNCIATION', 'SP_VISEME_15', 'SAFT16kHz16BitStereo',
    'SPPHRASERULE', 'SpeechVisemeFeature', 'SPEI_TTS_BOOKMARK',
    'ISpStream', 'SVP_9', 'SPEI_END_SR_STREAM',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SOTsItem', 'SDTProperty',
    'ISpProperties', 'SPVISEMES', 'SPRST_NUM_STATES',
    'DISPID_SPRuleNumberOfElements', 'SECFNoSpecialChars',
    'DISPID_SPARecoResult', 'SPEI_SR_PRIVATE',
    'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCAudioInInterferenceStatus', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE3', 'ISpeechPhraseElements',
    'DISPID_SOTCEnumerateTokens', 'SPSUnknown',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCResume', 'SVPOver',
    'DISPID_SGRsDynamic', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechLexiconProns', 'ISpeechPhraseAlternates',
    'DISPID_SPIReplacements', 'ISpeechRecognizer',
    'ISpeechAudioStatus', 'SPEI_SOUND_END', 'SpeechRunState',
    'SP_VISEME_16', 'SPSEMANTICFORMAT', 'DISPID_SVResume',
    'STCInprocServer', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_13',
    'SpeechTokenValueCLSID', 'tagSPPROPERTYINFO',
    'DISPID_SLPSymbolic', 'SP_VISEME_8',
    'DISPID_SRGCmdLoadFromResource', 'eWORDTYPE_ADDED',
    'SPEI_END_INPUT_STREAM', 'SPBO_PAUSE', 'SpFileStream',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE8', 'SPLOADOPTIONS',
    'SPINTERFERENCE_NOSIGNAL', 'tagSTATSTG', 'DISPID_SRCEBookmark',
    'SPEI_RESERVED5', 'ISpeechWaveFormatEx', 'DISPID_SMSALineId',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SLTUser',
    'SAFT8kHz8BitMono', 'SSFMOpenReadWrite', 'SPPS_RESERVED3',
    'SRAONone', 'SPCATEGORYTYPE', 'DISPID_SRRDiscardResultInfo',
    'SPSTREAMFORMATTYPE', 'DISPID_SVSLastResult', 'SDTAlternates',
    'DISPID_SRCEHypothesis', 'SPFM_NUM_MODES', 'SPEI_TTS_PRIVATE',
    'SPEI_MIN_SR', 'SAFTExtendedAudioFormat', 'DISPID_SBSRead',
    'SVSFNLPMask', 'SPVPRI_OVER', 'SAFT44kHz16BitStereo', 'SRAExport',
    'SDA_Consume_Leading_Spaces', 'ISpeechLexiconWords', 'UINT_PTR',
    'SAFT32kHz8BitStereo', 'SPPARTOFSPEECH', 'SPAUDIOSTATE',
    'DISPID_SVEBookmark', 'ISpeechRecoResult2', 'DISPID_SASState',
    'SAFT24kHz8BitMono', 'DISPID_SWFEFormatTag',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_VISEME', 'SAFT16kHz8BitMono',
    'SAFTADPCM_8kHzMono', 'DISPID_SOTCDefault',
    '__MIDL_IWinTypes_0009', 'ISpeechCustomStream',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPIRule', 'SPAR_High',
    'DISPID_SLGetGenerationChange', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechPhraseReplacement', 'SPSLMA', 'DISPID_SGRsCommit',
    'DISPID_SPACommit', 'SPADAPTATIONRELEVANCE', 'DISPID_SPEsCount',
    'SpeechAudioFormatGUIDText', 'SREPrivate', 'SRAInterpreter',
    'SPAS_STOP', 'ISpeechXMLRecoResult', 'SPXRO_SML',
    'ISpeechRecoResultDispatch', 'SPBO_NONE', 'SPCT_SUB_DICTATION',
    'SpeechLexiconType', 'SINoise', 'SAFT12kHz8BitStereo',
    'DISPID_SLWsCount', 'DISPID_SVAudioOutputStream',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_RECOGNITION',
    'SPWF_SRENGINE', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPEDisplayAttributes', 'SpeechPropertyResourceUsage',
    'SpeechStreamFileMode', 'DISPID_SWFEChannels', 'SPEVENT',
    'DISPID_SpeechObjectTokens', 'SPINTERFERENCE', 'DISPID_SPRuleId',
    'DISPID_SRGetPropertyNumber', 'ISpResourceManager',
    'SRTExtendableParse', 'SRSEIsSpeaking', 'ISpObjectTokenCategory',
    'DISPID_SRGCommit', 'SPGS_ENABLED', 'eLEXTYPE_MORPHOLOGY',
    'SVP_10', 'DISPID_SpeechLexiconWords', 'DISPID_SPIStartTime',
    'SpeechTokenShellFolder', 'SREAdaptation', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRText', 'SPGS_EXCLUSIVE',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVGetVoices',
    'DISPID_SpeechObjectToken', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SAStatus', 'DISPID_SRRAudioFormat', 'SPEI_RESERVED1',
    'SpeechDiscardType', 'SRTEmulated', 'DISPID_SDKSetLongValue',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpSerializeState',
    'ISpRecoCategory', 'DISPID_SDKCreateKey',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRSCurrentStreamNumber',
    'SDKLCurrentUser', 'DISPID_SLPPhoneIds', 'SpeechAudioVolume',
    'SpMMAudioOut', 'SECFEmulateResult', 'DISPID_SGRSTsItem',
    'SpTextSelectionInformation', 'DISPID_SRGCmdSetRuleState',
    'SPVPRI_ALERT', 'SVSFParseMask', 'DISPID_SFSClose',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SAVolume',
    'ISpeechPhraseReplacements', 'DISPID_SpeechGrammarRuleState',
    'SPWORDLIST', 'DISPID_SpeechRecognizer', 'DISPID_SPPsCount',
    'DISPID_SRGSetTextSelection', 'SPINTERFERENCE_LATENCY_WARNING',
    'SREStreamEnd', 'SDA_Two_Trailing_Spaces',
    'DISPIDSPTSI_ActiveLength', 'SPAS_PAUSE',
    'SpeechDictationTopicSpelling', 'SP_VISEME_13',
    'DISPID_SRRTStreamTime', 'DISPID_SLWsItem',
    'DISPID_SAEventHandle', 'SP_VISEME_3',
    'DISPID_SAFGetWaveFormatEx', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SDA_One_Trailing_Space', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE17', 'SPPS_RESERVED1', 'SREBookmark',
    'SpeechUserTraining', 'DISPID_SBSSeek', 'SFTInput',
    'SGRSTTWildcard', 'SPAUDIOBUFFERINFO', 'SAFT11kHz16BitStereo',
    'DISPID_SGRSTRule', 'DISPID_SRCRecognizer',
    'DISPID_SRCERecognizerStateChange', 'SpeechVisemeType',
    'DISPID_SpeechGrammarRuleStateTransition', 'SDTDisplayText',
    'DISPID_SRIsShared', 'ISpAudio',
    'DISPID_SpeechLexiconPronunciation',
    'SWPUnknownWordUnpronounceable', 'SPGRAMMARWORDTYPE',
    'SINoSignal', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPIAudioStreamPosition', 'ISpeechLexiconPronunciation',
    'DISPID_SRGRules', 'SVESentenceBoundary', 'ISpStreamFormat',
    'SPPHRASE', 'SSFMOpenForRead', 'SpeechDataKeyLocation',
    'SP_VISEME_1', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT16kHz16BitMono',
    'DISPID_SPRuleParent', 'DISPID_SABIMinNotification',
    'SPFM_OPEN_READWRITE', 'DISPID_SDKDeleteValue',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_14',
    'DISPID_SRIsUISupported', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SGRSTPropertyValue', 'SAFT11kHz8BitStereo',
    'SVEAllEvents', 'ISpPhoneConverter', 'SSTTWildcard',
    'ISpRecognizer3', 'DISPID_SRCRequestedUIType', 'SVEVoiceChange',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SGRAttributes', 'DISPID_SpeechBaseStream',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGDictationSetState',
    'SREPropertyStringChange', 'SREAudioLevel',
    'DISPID_SLGetPronunciations', 'DISPID_SRProfile',
    'DISPID_SPEPronunciation', 'DISPID_SpeechRecoResult2',
    'SECFIgnoreKanaType', 'SPRS_INACTIVE', 'SSFMCreate',
    'DISPID_SpeechGrammarRules',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE15', 'SpeechVoicePriority', 'SVSFIsXML',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechPhraseInfo',
    'SECLowConfidence', 'DISPID_SPPName',
    'DISPIDSPTSI_SelectionLength', 'ISpeechPhraseElement',
    'STSF_LocalAppData', 'SVP_21', 'SPAO_RETAIN_AUDIO',
    ...
    'SP_VISEME_0', 'DISPID_SPRDisplayAttributes', 'SGRSTTDictation',
    'SpeechGrammarWordType', 'SGLexical',
    'DISPID_SRGetPropertyString', 'SPPHRASEREPLACEMENT',
    'SAFTGSM610_8kHzMono', 'SGPronounciation', 'ISpVoice',
    'SpeechGrammarTagDictation', 'DISPID_SGRName',
    'SpeechEngineConfidence', 'DISPIDSPTSI_ActiveOffset',
    'SAFTADPCM_8kHzStereo', 'SPCS_DISABLED', 'SPSFunction',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVSVisemeId', 'SRCS_Disabled',
    'DISPID_SRGCmdLoadFromFile', 'SPXRO_Alternates_SML',
    'SP_VISEME_20', 'SAFT12kHz16BitMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCESoundEnd', 'SDTPronunciation', 'ISpRecoGrammar2',
    'DISPID_SOTDisplayUI', 'DISPID_SRRSaveToMemory',
    'SPWORDPRONUNCIATION', 'DISPID_SOTCGetDataKey',
    'DISPID_SDKGetStringValue', 'DISPID_SRCBookmark',
    'SRAORetainAudio', 'SAFT11kHz8BitMono', 'SGDisplay',
    'SPEI_MAX_SR', 'SPRULESTATE', 'SPPROPERTYINFO', 'SVEPhoneme',
    'eLEXTYPE_PRIVATE2', 'SPRST_ACTIVE', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SOTSetId', 'DISPID_SVSInputSentencePosition',
    'eLEXTYPE_PRIVATE18', 'DISPID_SAFGuid', 'ISpeechAudioBufferInfo',
    'SECFDefault', 'DISPID_SRRPhraseInfo', 'SPEI_UNDEFINED',
    'DISPID_SPCLangId', 'SLTApp', 'DISPID_SRStatus',
    'ISpRecoContext2', 'SVP_2', 'SRERecoOtherContext',
    'DISPID_SPPValue', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SFSOpen', 'SVEWordBoundary', 'ISpeechFileStream',
    'DISPID_SMSADeviceId', 'DISPID_SRCERequestUI',
    'DISPID_SGRAddResource', 'DISPID_SGRsCommitAndSave',
    'ISpeechGrammarRule', 'SVF_Stressed', 'DISPID_SASFreeBufferSpace',
    'STCLocalServer', 'SPPS_RESERVED4',
    'DISPID_SpeechAudioBufferInfo', 'SASPause', 'SVSFParseSapi',
    'tagSPTEXTSELECTIONINFO', 'ISpPhrase',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechGrammarRule',
    'DISPID_SRRSpeakAudio', 'SpVoice', 'DISPID_SLPs_NewEnum',
    'SAFT8kHz8BitStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechRecognizerStatus', 'SAFT44kHz16BitMono',
    'SVPNormal', 'DISPID_SRGetRecognizers', 'ISpeechBaseStream',
    'DISPID_SPILanguageId', 'SITooLoud',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SVEStartInputStream', 'DISPID_SGRAddState', 'SPWORDTYPE',
    'DISPID_SpeechAudioFormat', 'SGRSTTEpsilon',
    'DISPID_SpeechPhraseBuilder', 'SPWT_DISPLAY',
    'SVSFParseAutodetect', 'DISPID_SPELexicalForm', 'SP_VISEME_19',
    'LONG_PTR', 'SECNormalConfidence', 'SBOPause',
    'SDKLCurrentConfig', 'DISPID_SpeechVoice', 'DISPID_SRAudioInput',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_SR_BOOKMARK',
    'SRERecognition', 'SPSMF_UPS', 'SpeechCategoryAppLexicons',
    'SPPHRASEELEMENT', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPPParent', 'SAFT22kHz16BitMono', 'DISPID_SCSBaseStream',
    'ISpeechPhoneConverter', 'SGDSActiveUserDelimited',
    'DISPID_SpeechAudio', 'DISPID_SPRuleName', 'ISpeechPhraseRules',
    'DISPID_SPAStartElementInResult', 'SGDSActive',
    'SpeechTokenKeyFiles', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPINTERFERENCE_NONE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'STCRemoteServer', 'SAFT12kHz8BitMono',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPRs_NewEnum',
    'SPEI_WORD_BOUNDARY', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpRecognizer2', 'SSSPTRelativeToEnd', 'DISPID_SRSClsidEngine',
    'DISPID_SRDisplayUI', 'DISPID_SGRSTPropertyId',
    'ISpeechTextSelectionInformation', 'DISPID_SRGRecoContext',
    'DISPID_SWFEBlockAlign', 'SRTReSent', 'DISPID_SRCEAdaptation',
    'SVSFPersistXML', 'Speech_Max_Pron_Length',
    'DISPID_SPEEngineConfidence', 'SpCustomStream',
    'DISPID_SDKGetBinaryValue', 'SpSharedRecoContext',
    'SPAUDIOSTATUS', 'DISPID_SpeechRecoContext',
    'ISpeechGrammarRuleState', 'DISPID_SPPEngineConfidence',
    'DISPID_SPPFirstElement', 'DISPID_SABufferInfo', 'DISPID_SRGId',
    'SVPAlert', 'DISPID_SRRSetTextFeedback', 'DISPID_SLGetWords',
    'SVP_6', 'IEnumSpObjectTokens', 'eWORDTYPE_DELETED',
    'DISPID_SPRsCount', 'DISPID_SVEVoiceChange', 'SGDSInactive',
    'SPPS_Interjection', 'eLEXTYPE_PRIVATE12', 'ISpeechMemoryStream',
    'SPGRAMMARSTATE', 'SRSInactiveWithPurge',
    'SPEI_SENTENCE_BOUNDARY', 'SASStop',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVP_4', 'SPAR_Low',
    'SPWORDPRONOUNCEABLE', 'SPPS_Modifier',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_PRIVATE16',
    'WAVEFORMATEX', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCVoicePurgeEvent', 'SpPhoneticAlphabetConverter',
    'SVEPrivate', 'SPSHT_Unknown', 'SpeechRecoContextState',
    'SVSFNLPSpeakPunc', 'SPTEXTSELECTIONINFO', 'DISPID_SOTCId',
    'SREStreamStart', 'SRESoundStart', 'ISpeechResourceLoader',
    'SAFT8kHz16BitMono', 'DISPID_SPPBRestorePhraseFromMemory'
]

_check_version('1.2.1', 1699553575.506495)

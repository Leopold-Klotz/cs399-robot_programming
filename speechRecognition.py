"""
Code for local speech recognition using TorchAudio.
Full credit to: https://deepgram.com/learn/python-speech-recognition-locally-torchaudio
"""
...
def start_recording_and_transcribing(device: str, src: str, bundle: torchaudio.pipelines) -> str:
    '''Starts recording and transcribing audio data
    ...
    if __name__ == "__main__":
        main(device, src, bundle)
    
    return "transcript.txt"
   
if __name__ == "__main__":
   main(
       device="avfoundation", # macOS
       src=":1", # macOS
